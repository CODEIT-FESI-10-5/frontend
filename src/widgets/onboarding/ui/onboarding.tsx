        ...
        <div className="flex max-w-6xl items-center gap-30">
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-col gap-16">
              <button
                className="rounded-8 bg-primary w-full cursor-pointer px-48 py-16 text-white transition-colors hover:bg-[#5d6dd4]"
              ...
              {/* 초대 모달 */}
              <button
                className="rounded-8 bg-tertiary w-full cursor-pointer px-48 py-16 text-white transition-colors hover:bg-[#1f2553]"
