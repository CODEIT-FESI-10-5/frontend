...
export default function UpdateStudyImage({ studyId }: UpdateStudyImageProps) {
  ...
  return (
    <>
      ...
      >
        <Link href="/note">
          <button className="m-label-small sm:body-small text-text-primary flex items-center justify-center rounded-full border border-[#a9abb9] px-8 py-4 sm:px-10 sm:py-6">
            노트 모아보기
          </button>
        </Link>
        <button
